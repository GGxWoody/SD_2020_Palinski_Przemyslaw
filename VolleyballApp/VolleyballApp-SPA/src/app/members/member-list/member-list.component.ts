...
export class MemberListComponent implements OnInit {
  ...
  userTypeList = [{value: 'player', display: 'Players'}, {value: 'referee', display: 'Referees'},
  {value: 'organiser', display: 'Organisers'}];
  userParams: any = {};
  ...
  ngOnInit() {
    ...
    this.userParams.userType = 'player';
  ...
  resetFilters() {
    this.userParams.gender = this.user.gender = 'all';
    this.userParams.userType = 'player';
    this.userParams.minAge = 18;
    this.userParams.maxAge = 99;
    this.loadUsers();
